...
public class Scrollbar extends Widget {
	...
	protected void renderContent(GraphicsContext g, int contentWidth, int contentHeight) {
		...
		if (this.horizontal) {
			...
			barX = getBarPosition(contentWidth, barWidth);
			barHeight = barSize;
		} else {
			...
			barY = getBarPosition(contentHeight, barHeight);
			barWidth = barSize;
		}
	...
	private int getBarPosition(int totalSize, int barSize) {
		return this.value * (totalSize - barSize) / this.maximum;
	}
